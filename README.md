...
**The sweetest way to build AI workflows - A visual workflow builder for creating agent pipelines**
...
Watermelon is a visual workflow builder for creating AI agent pipelines powered by [Firecrawl](https://firecrawl.dev). Design complex agent workflows with a drag-and-drop interface, then execute them with real-time streaming updates. Sweet, simple, and powerful.
...
npm install
# Note: This project is now rebranded as Watermelon 🍉
```
